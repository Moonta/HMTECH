		...
		<div id="page-wrapper">
					...
					<div class="container" id="main">
						...
						<!-- Content -->
							<article id="content">
								<header>
									<h2>회사개요</h2>
									<p>(주)에이치엠텍은 <strong>자체 AC LED 조명 제품 기술을 소유한 회사</strong>로서 그 기술을 바탕으로<br/> 최고 품질의 제품을 변화하는 시장에 맞추어 생산/공급하며 세계 시장에 AC LED 조명 제품을 이끌어가는 리더가 되려합니다.</p>
								</header>
								

								<a class="image featured"><img src="<c:url value='/images/456.PNG'/>" alt="" /></a>
			...
			<!-- Footer -->
				<div id="footer-wrapper">
					...
					<img src="<c:url value='/images/hmtech.png'/>" style="margin-left: auto; margin-right: auto; display: block; width: 20%;" >
					<br><br>
